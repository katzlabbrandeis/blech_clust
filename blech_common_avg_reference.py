...
electrode_layout_frame['CAR_group'] = electrode_layout_frame['CAR_group'].astype(
    str)
...
if 'original_CAR_group' in electrode_layout_frame.columns:
    ...
    print('='*60)
    electrode_layout_frame['CAR_group'] = electrode_layout_frame['original_CAR_group'].astype(
        str)
