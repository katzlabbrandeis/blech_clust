...
def extract_unit_characteristics(dir_name):
    """
    Extract unit-level characteristics using ephys_data.profile_units method.
    Falls back to reading from aggregated_characteristics.csv if profile_units
    is not available.
    ...
    Returns:
        ...
        - sig_fraction: Fraction of significant units
    """
