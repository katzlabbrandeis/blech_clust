...
def blech_process(electrode_num):
    ...
    if os.path.isdir(os.path.join(dir_name, 'Plots/'+str(electrode_num))):
            shutil.rmtree(os.path.join(dir_name, 'Plots/'+str(electrode_num)))
    if os.path.isdir(os.path.join(dir_name, 'spike_waveforms/electrode'+str(electrode_num))):
            shutil.rmtree(os.path.join(dir_name, 'spike_waveforms/electrode'+str(electrode_num)))
    if os.path.isdir(os.path.join(dir_name, 'spike_times/electrode'+str(electrode_num))):
            shutil.rmtree(os.path.join(dir_name, 'spike_times/electrode'+str(electrode_num)))
    if os.path.isdir(os.path.join(dir_name, 'clustering_results/electrode'+str(electrode_num))):
            shutil.rmtree(os.path.join(dir_name, 'clustering_results/electrode'+str(electrode_num)))

    # Then make all these directories
    os.mkdir(os.path.join(dir_name, 'Plots/'+str(electrode_num)))
    #os.mkdir(os.path.join(dir_name, 'Plots/%i/Plots' % electrode_num))
    #os.mkdir(os.path.join(dir_name, 'Plots/%i' % electrode_num))
    os.mkdir(os.path.join(dir_name, 'spike_waveforms/electrode'+str(electrode_num)))
    os.mkdir(os.path.join(dir_name, 'spike_times/electrode'+str(electrode_num)))
    os.mkdir(os.path.join(dir_name, 'clustering_results/electrode'+str(electrode_num)))
    ...
    f = open(os.path.join(dir_name,params_file), 'r')
    params = []
    for line in f.readlines():
            params.append(line)
    f.close()
    ...
    raw_el = hf5.get_node('/raw/','electrode{}'.format(electrode_num))[:]
    hf5.close()
    ...
    fig.savefig(os.path.join(dir_name, 'Plots/%i/cutoff_time.png' % electrode_num), bbox_inches='tight')
    plt.close("all")
    ...
    del slices; del spike_times; del polarity

    # Save these slices/spike waveforms and their times to their respective folders
    np.save(os.path.join(dir_name, 'spike_waveforms/electrode%i/spike_waveforms.npy' % electrode_num), slices_dejittered)
    #np.save(os.path.join(dir_name, 'spike_waveforms/electrode%i/spike_waveform_derivative.npy' % electrode_num), slices_derivatives)
    np.save(os.path.join(dir_name, 'spike_waveforms/electrode%i/spike_autocorrelation.npy' % electrode_num), slices_autocorr)
    np.save(os.path.join(dir_name, 'spike_times/electrode%i/spike_times.npy' % electrode_num), times_dejittered)
    ...
    np.save(os.path.join(dir_name, 'spike_waveforms/electrode%i/pca_waveforms.npy' % electrode_num), pca_slices)
    #np.save(os.path.join(dir_name, 'spike_waveforms/electrode%i/pca_waveform_derivative.npy' % electrode_num), pca_derivatives)
    np.save(os.path.join(dir_name, 'spike_waveforms/electrode%i/pca_waveform_autocorrelation.npy' % electrode_num), pca_autocorr)
    np.save(os.path.join(dir_name, 'spike_waveforms/electrode%i/energy.npy' % electrode_num), energy)
    np.save(os.path.join(dir_name, 'spike_waveforms/electrode%i/spike_amplitudes.npy' % electrode_num), amplitudes)
    ...
    fig.savefig(os.path.join(dir_name, 'Plots/%i/pca_variance.png' % electrode_num), bbox_inches='tight')
    plt.close("all")
    ...
    # This step is likely extraneous and can be removed in the future
    ...
    for i in range(max_clusters-1):
            ...
            np.save(os.path.join(dir_name, 'clustering_results/electrode%i/clusters%i/predictions.npy' % (electrode_num, i+2)), predictions)
            #np.save(os.path.join(dir_name, 'clustering_results/electrode%i/clusters%i/bic.npy' % (electrode_num, i+2), bic)

            # Plot the graphs, for this set of clusters, in the directory made for this electrode
            os.mkdir(os.path.join(dir_name, 'Plots/%i/%i_clusters' % (electrode_num, i+2)))
            ...
            for feature1 in range(len(data[0])):
                    for feature2 in range(len(data[0])):
                            if feature1 < feature2:
                                    ...
                                    fig.savefig(os.path.join(dir_name, 'Plots/%i/%i_clusters/feature%ivs%i.png' % (electrode_num, i+2, feature2, feature1)))
                                    plt.close("all")
    ...
    print('Electrode {} complete.'.format(electrode_num))
