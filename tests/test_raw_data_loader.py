...
class TestRawDataLoader(unittest.TestCase):
    ...
    def _create_test_hdf5(self):
        ...
        with tables.open_file(self.hdf5_path, 'w') as hf5:
            ...
            for i in range(3):
                ...
                data += (np.sin(2 * np.pi * 10 * np.arange(n_samples) / self.sampling_rate) * 100).astype(np.int16)
    ...
    def test_context_manager(self):
        ...
        with RawDataLoader(self.hdf5_path) as loader:
            ...
            data, _ = loader.load_channel_data('electrode00', 'raw', start_time=0, end_time=1)
