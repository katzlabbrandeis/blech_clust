...
class TestEphysDataCore:
    ...
    def test_calc_conv_rates_static_method(self):
        ...
        spike_array = np.random.randint(0, 2, (2, 5, 1000))  # 2 neurons, 5 trials, 1000 time points
    ...
    def test_calc_baks_rate_static_method(self):
        ...
        spike_array = np.random.randint(0, 2, (1, 2, 100))  # 1 neuron, 2 trials, 100 time points
