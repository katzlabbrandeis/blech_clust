...
conda install -c conda-forge numba=0.53.1 -y
conda install -c conda-forge numpy=1.19.5 -y
conda install -c conda-forge pandas=1.1.5 -y
conda install -c conda-forge psutil=5.8.0 -y
conda install -c conda-forge pytables=3.6.1 -y
conda install -c conda-forge scikit-learn=0.22.1 -y
